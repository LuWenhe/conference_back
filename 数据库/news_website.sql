...
CREATE TABLE `news` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `picture_path` varchar(60) DEFAULT NULL COMMENT '图片',
...
-- Records of news
-- ----------------------------
INSERT INTO `news` VALUES ('187', null, '支持单位', '2023-03-10', '187', '<p><span style=\"background-color: rgb(255, 255, 255);\">Organizer&nbsp;</span></p><p><img src=\"http://localhost:7070/images\\e2b214e5-8e0a-4c49-9d6c-4dbe33ec8bcb.png\" style=\"\" width=\"143\">   <img src=\"http://localhost:7070/images\\c8ce45a0-6f86-43b7-a42f-73b25c6c4c5b.png\" style=\"\" width=\"143\">   </p>', '46', '2023-03-10 00:26:26', '2023-03-16 11:39:33');
INSERT INTO `news` VALUES ('195', 'images\\44c67be0-b6a6-4b99-8cd1-c719ae7cdd79.png', '轮播1', '2023-03-10', '0', '', '45', '2023-03-10 16:36:20', '2023-03-10 16:36:20');
INSERT INTO `news` VALUES ('196', 'images\\001f2b2a-cdde-421e-8938-e3d5332a0c28.png', '轮播2', '2023-03-10', '0', '', '45', '2023-03-10 16:36:37', '2023-03-10 16:36:37');
